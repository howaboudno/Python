...
def get_all_predictions_for_fixture(
    ...
    predictions = db.query(FixturePrediction).filter(
        FixturePrediction.fixture_id == fixture_id
    ).all()
    ...
    for p in predictions:
        ...
        results.append({
            ...
            "predicted_score_1": p.predicted_score_1,
            "predicted_score_2": p.predicted_score_2,
            "predicted_pen_score_1": p.predicted_pen_score_1,
            "predicted_pen_score_2": p.predicted_pen_score_2
        })
